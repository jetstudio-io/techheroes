...
class Yotpo_Yotpo_Helper_ApiClient extends Mage_Core_Helper_Abstract
{
	...
	public function __construct()
	{
		...
		$OAuthStorePath = Mage::getModuleDir('', 'Yotpo_Yotpo') . DS . 'lib' . DS .'oauth-php' . DS .'library' . DS .'OAuthStore.php';
		$OAuthRequesterPath = Mage::getModuleDir('', 'Yotpo_Yotpo') . DS . 'lib' . DS .'oauth-php' . DS .'library' . DS .'OAuthRequester.php';
